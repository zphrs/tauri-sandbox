...
type Add = Notification<"add", {
    value: unknown;
    key?: IDBValidKey;
}>;
type Clear = Notification<"clear", undefined>;
type Delete = Notification<"delete", {
    query: SerializedQuery;
}>;
type Put = Notification<"put", {
    value: unknown;
    key?: IDBValidKey;
}>;
type Replace = Notification<"replace", {
    key: string;
    index: string;
    value: string;
}>;
...
export type ExecuteTransactionMethod = Method<"executeTransaction", WriteLog, undefined>;
export {};
