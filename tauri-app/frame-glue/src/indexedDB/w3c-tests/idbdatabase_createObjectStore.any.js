...
async_test((t) => {
    ...
    open_rq.onupgradeneeded = function (e) {
        ...
        assert_true(
            objStore instanceof IDBObjectStore,
...
async_test((t) => {
    ...
    open_rq.onupgradeneeded = function (e) {
        ...
        for (let i = 0; i < 5; i++) store.add("object_" + i, i)
...
optionalParameters("autoInc true, keyPath null", {
    autoIncrement: true,
    keyPath: null,
})

optionalParameters("autoInc true, keyPath undefined", {
    autoIncrement: true,
    keyPath: undefined,
})

optionalParameters("autoInc true, keyPath string", {
    autoIncrement: true,
    keyPath: "a",
})

optionalParameters("autoInc false, keyPath empty", {
    autoIncrement: false,
    keyPath: "",
})

optionalParameters("autoInc false, keyPath array", {
    autoIncrement: false,
    keyPath: ["h", "j"],
})

optionalParameters("autoInc false, keyPath string", {
    autoIncrement: false,
    keyPath: "abc",
})
