...
const bigints = [-12345678901234567890n, -1n, 0n, 1n, 12345678901234567890n]
...
;[].concat(booleans, numbers, bigints, strings).forEach((value) =>
    cloneObjectTest(Object(value), (orig, clone) => {
...
;[
    ...
    cloneObjectTest(value, (orig, clone) => {
