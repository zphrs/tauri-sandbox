...
export type GetAllRecordsMethod = ReadMethod<
    GetAllRecords,
    [unknown[], GetAllKeysMethod["res"]["result"]]
>

export type GetAllRecordsFromIndexMethod = ReadMethod<
    GetAllRecordsFromIndex,
    [unknown[], IDBValidKey[]]
>

export type GetNextFromCursorMethod = ReadMethod<
    GetNextFromCursor,
    | {
          key: IDBValidKey
          value: unknown
...
type ReadMethod<R extends Read, Return> = Method<
    "executeRead",
